...
To get a reverse shell, we would just need to execute ur binary and listen in the attack host with [nc](). For Windows machines, it is better to use [rlwrap](https://github.com/hanslub42/rlwrap) before the command.
